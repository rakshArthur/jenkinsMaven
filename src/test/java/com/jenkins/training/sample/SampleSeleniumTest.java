...
public class SampleSeleniumTest {
	...
	public void startBrowser() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\rakyadav1\\Downloads\\chromedriver_win32\\chromedriver.exe");
	...
	public void validateGoogleId() throws Exception {
		...
		//driver.findElement(By.xpath("/html/body/div[2]/div/div[4]/ul/li[2]/a")).click();
		/*
		...
		Thread.sleep(5000);
		boolean textFound = driver.getPageSource().contains("Sign in");
		AssertJUnit.assertTrue(textFound);
	}
