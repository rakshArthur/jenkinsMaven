...
public class SampleSeleniumTest {
	 ...
	 * "C:\\Users\\rakyadav1\\Downloads\\chromedriver_win32\\chromedriver.exe");
	 * ChromeOptions chromeOptions = new ChromeOptions();
	 * chromeOptions.addArguments("--start-maximized"); driver = new
	 * ChromeDriver(chromeOptions); }
	 * 
	 * @Test public void validateGoogleId() throws Exception {
	 * System.out.println("Opening Browser"); driver.get("http://www.google.com");
	 * System.out.println("Clicking Gmail Link");
	 * driver.findElement(By.xpath("//*[@id=\"gbw\"]/div/div/div[1]/div[1]/a")).
	 * click(); System.out.println("Clicking Sign In link");
	 * //driver.findElement(By.xpath("/html/body/div[2]/div/div[4]/ul/li[2]/a")).
	 * click();
	 * 
	 * System.out.println("Entering username");
	 * driver.findElement(By.xpath("//*[@id=\"identifierId\"]")).sendKeys(
	 * "raksh.0804"); System.out.println("Clicking Next button");
	 * driver.findElement(By.xpath("//*[@id=\"identifierNext\"]/content/span")).
	 * click(); Thread.sleep(5000); boolean textFound =
	 * driver.getPageSource().contains("Forgot password");
	 * AssertJUnit.assertTrue(textFound);
	 * 
	 * 
	 * Thread.sleep(5000); boolean textFound =
